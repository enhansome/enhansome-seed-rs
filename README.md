...
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,387 | 🐛 136 | 🌐 Rust | 📅 2026-08-26 - WASM web application bundler for Rust.
...
* [Pslink](https://pslink.teilgedanken.de) - An URL-shortener page focused on use in publications ([demo](https://demo.pslink.teilgedanken.de/app/) (user, password: demo)).  Uses `Seed`, [`actix-web`](https://actix.rs/), and [`sqlx`](https://github.com/launchbadge/sqlx) ⭐ 17,453 | 🐛 767 | 🌐 Rust | 📅 2026-09-04.
